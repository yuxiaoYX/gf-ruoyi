...
CREATE TABLE `sys_user`  (
  ...
  `role_ids` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '角色id字符串',
  `shop_ids` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '店铺ID字符串',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '后台用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '张三', 'admin', '13306955996', NULL, '1', NULL, NULL, NULL, NULL, '2016-12-10 18:20:54', '2001-05-07 07:48:15', NULL);
INSERT INTO `sys_user` VALUES (2, 'admin1', '熊子韬', 'admin1', '13383097147', NULL, '1', NULL, NULL, NULL, NULL, '2001-05-22 16:40:18', '2019-12-26 04:10:40', NULL);
INSERT INTO `sys_user` VALUES (3, 'Song Ziyi', '宋子异', 'N57icHZE8H', '13380294485', NULL, '1', NULL, NULL, NULL, NULL, '2011-04-29 23:10:39', '2014-07-10 11:58:56', NULL);
INSERT INTO `sys_user` VALUES (4, 'Jiang Xiuying', '蒋秀英', 'TEOWJ9MQWw', '13308985072', NULL, '1', NULL, NULL, NULL, NULL, '2006-04-27 18:26:31', '2010-10-28 07:19:29', NULL);
INSERT INTO `sys_user` VALUES (5, 'Yu Lu', '于璐', 'nKfJlwcUWP', '13377340669', NULL, '1', NULL, NULL, NULL, NULL, '2016-05-02 11:19:09', '2008-07-15 21:30:40', NULL);
INSERT INTO `sys_user` VALUES (6, 'Zhu Yunxi', '朱云熙', 'J7hOluztMq', '13374414913', NULL, '1', NULL, NULL, NULL, NULL, '2008-02-18 00:16:40', '2018-12-06 12:56:27', NULL);
INSERT INTO `sys_user` VALUES (7, 'He Shihan', '贺詩涵', 'ZDy2TpkJzA', '13346790787', NULL, '1', NULL, NULL, NULL, NULL, '2018-01-27 22:41:00', '2018-04-21 17:59:59', NULL);
INSERT INTO `sys_user` VALUES (8, 'Meng Rui', '孟睿', 'gyG1kFURfE', '13385848456', NULL, '1', NULL, NULL, NULL, NULL, '2003-10-28 03:01:26', '2011-08-08 22:08:15', NULL);
INSERT INTO `sys_user` VALUES (9, 'Yao Lan', '姚岚', 'FH8NvNHZym', '13391029254', NULL, '1', NULL, NULL, NULL, NULL, '2007-09-06 00:04:00', '2001-01-05 21:15:59', NULL);
INSERT INTO `sys_user` VALUES (10, 'Shi Shihan', '石詩涵', 'NbYJFTzvA2', '13337380665', NULL, '1', NULL, NULL, NULL, NULL, '2021-07-07 14:28:18', '2001-04-15 00:27:39', NULL);
...
) ENGINE = MyISAM AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户在线状态表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user_online` VALUES (28, '1uzr24fch1vqgcmr72w200cnh35fdsr1', 2, 'admin1', '127.0.0.1', 'Chrome', 'Windows 7', '2022-01-10 17:17:07');
